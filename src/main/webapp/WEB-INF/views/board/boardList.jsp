    ...
    <div class="paging">
        ...
        <c:if test="${totalCnt!=null && totalCnt!=0}">
            <c:if test="${ph.showPrev}">
                <a class="page" href="<c:url value="/board/boardList?page=${ph.beginPage-1}"/>">&lt;</a>
            </c:if>
            <c:forEach var="i" begin="${ph.beginPage}" end="${ph.endPage}">
                <a class="page ${i==ph.page ? 'active' : ""}" href="<c:url value="/board/boardList?page=${i}"/>">${i}</a>
            </c:forEach>
            <c:if test="${ph.showNext}">
                <a class="page" href="<c:url value="/board/boardList?page=${ph.endPage+1}"/>">&gt;</a>
            </c:if>
        </c:if>
    </div>
</div>
