...
##### 2024.08.06 AM 09:00 ~ ~~현재 서버 실행중~~ → 서버 종료
###### 2024.09.24 PM 13:24 이후 서버 종료, 기능 변경 및 운영 서버 변경 예정(AWS EC2 → Vultr)
<br>
...
<h3>1. Spring Security 기반의 JWT 방식의 OAuth2.0 인증로그인 </h3>
  ...
  <img style="width:100%" src="https://github.com/user-attachments/assets/67d83eca-40ac-4a45-b2d0-91ca8fd8290f">
    </div>
  </details>
<br>
<div>
